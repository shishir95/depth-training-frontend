...
export default function MembershipPage() {
  return (
    <PageShell padY="py-16" maxWidth="max-w-7xl" className="space-y-16">
      ...
      <section className="relative overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-br from-zinc-950 via-[#05030f] to-black px-6 py-12 sm:px-10">
        <div
          aria-hidden="true"
          ...
          <div className="rounded-3xl border border-white/10 bg-gradient-to-br from-[var(--depth-accent)]/15 via-black to-black p-6 shadow-[0_25px_70px_rgba(0,0,0,0.55)]">
            ...
            <div className="mt-5 rounded-3xl border border-white/10 bg-black/30 p-6">
              ...
              <div className="mt-2 flex items-baseline gap-2">
                ...
                <span className="text-sm text-[var(--depth-muted)]">/ month</span>
              </div>
      ...
      <section className="relative overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-br from-[#05030f] via-black to-[#0b0612] px-6 py-12 sm:px-10">
        <div
          aria-hidden="true"
