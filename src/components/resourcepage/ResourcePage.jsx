...
function BlogCard({ post }) {
  return (
    <motion.article
      ...
      className="group relative flex h-full flex-col overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-br from-[var(--depth-accent)]/12 via-[#0c070d] to-black shadow-[0_18px_55px_rgba(0,0,0,0.55)] transition hover:border-[var(--depth-accent)]/70 hover:shadow-[0_24px_70px_rgba(0,0,0,0.65)]"
    >
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_top,_rgba(244,129,111,0.16),_transparent_52%)] opacity-80" />

      <div className="relative h-40 w-full overflow-hidden bg-gradient-to-tr from-[var(--depth-accent-soft)]/24 via-zinc-900 to-black">
...
function SidebarCTA() {
  return (
    <div className="rounded-3xl border border-[var(--depth-accent)]/60 bg-gradient-to-b from-[var(--depth-accent)]/12 via-[#0c070d] to-black p-6 shadow-[0_20px_60px_rgba(0,0,0,0.55)]">
